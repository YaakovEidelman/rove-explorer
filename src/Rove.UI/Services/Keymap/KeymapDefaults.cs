    ...
    {
        {
            ...
            [
                ...
                new(K(Key.A, KeyModifiers.Control), CommandDef.ContentSelectAll.Id),
                new(K(Key.D, KeyModifiers.Control), CommandDef.ContentDuplicate.Id),
                ...
                new(K(Key.X, KeyModifiers.Shift), CommandDef.MoveToHere.Id),
                new(K(Key.Y, KeyModifiers.Shift), CommandDef.CopyToHere.Id),
                new(K(Key.C), CommandDef.CopyPath.Id),
                new(K(Key.E), CommandDef.ExtractArchives.Id),
                new(K(Key.Z), CommandDef.CompressItems.Id),
                new(K(Key.Z, KeyModifiers.Shift), CommandDef.CompressItemsTarGz.Id),
