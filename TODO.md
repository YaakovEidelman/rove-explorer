...
4. Hand-test the published AOT builds on real Wayland and Windows, not only the headless tests.
5. keybind config file has to be simpler
...
1. we need a nice first install show around.
